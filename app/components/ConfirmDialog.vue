  ...
  <Teleport to="body">
    <Transition name="modal">
      <div v-if="show" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
        ...
        <div :class="['relative bg-white dark:bg-slate-800 w-full max-w-sm mx-auto p-6 border border-gray-100 dark:border-slate-700', isAdmin ? 'rounded-none' : 'rounded-2xl shadow-xl dark:shadow-2xl']">
          <div class="flex items-start gap-3 mb-4">
            <div :class="['p-2 flex-shrink-0', isAdmin ? 'rounded-none' : 'rounded-full', iconVariants[variant]]">
