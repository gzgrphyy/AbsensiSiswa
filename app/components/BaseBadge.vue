...
<template>
  <span v-if="isAdmin" :class="['inline-flex items-center gap-1  rounded-none', adminVariants[variant] || adminVariants.gray, size === 'sm' ? 'px-1.5 py-0.5 text-xs' : 'px-2 py-0.5 text-xs']">
