    ...
    <header class="bg-white/80 backdrop-blur-sm shadow-sm border-b border-gray-200/60 sticky top-0 z-30">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <NuxtLink to="/admin" class="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 hidden sm:block">Kelola ruangan kelas dan generate QR Code</p>
          </div>
        </div>
