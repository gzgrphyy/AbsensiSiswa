...
const mockData = {
  ...
  aktivitas: [
    ...
    { waktu: '09:50', aksi: 'Konfirmasi massal', detail: 'Bahasa Inggris - XI-B (32 murid)' },
...
<template>
  <AppLayout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-5">
      <StatCard label="Jumlah PTK" :value="mockData.stats.totalGuru" variant="purple">
        <template #icon>
      ...
      <StatCard label="Jumlah Murid" :value="mockData.stats.totalSiswa" variant="green">
        <template #icon>
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <StatCard label="Ruangan Aktif" :value="mockData.stats.ruanganAktif" variant="primary">
        <template #icon>
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-300 dark:border-gray-600">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          ...
          <span class="text-xs text-gray-400 dark:text-gray-500 font-medium bg-gray-50 dark:bg-gray-700 px-2 py-1 rounded-sm">{{ mockData.topAlpha.length }} murid</span>
        </div>
