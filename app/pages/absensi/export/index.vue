  ...
  <PTKLayout>
    ...
    <div class="mt-4 bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-card dark:shadow-dark-card">
      <div class="flex items-center gap-3 p-4">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">File diunduh dalam format Excel (.xlsx). Lihat rekap lengkap di halaman <NuxtLink to="/absensi/rekap" class="text-primary-600 dark:text-primary-400 font-medium">Rekap Absensi</NuxtLink>.</p>
      </div>
    </div>
  </PTKLayout>
</template>
